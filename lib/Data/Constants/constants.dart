...

{
  ...
  ///urls
  static String baseURL="https://up4you.nl/app-upforu/api/v1/";
  static String loginURL="login_api";
  static String filterPlaceURL="place_filter";


  static String registrationURL="register_me";
  static String nearbyPlacesURL="nearby_places";
  static String allPlacesURL="get_all_places";
  static String favPlacesURL="get_favorite";
  static String addFavURL="add_favorite";


  static String pushReviewURL="add_review";
  static String allReviewsURL="place_reviews";
  static String logoutURL="logout_api";

  ///error Messages
  static String statusError="Something went wrong";
  static String serveError="Server is down";
  ...
  static String failedMessage='Failed';
  static String loginFailedMessage='Incorrect credentials';
  static String registerSuccessMessage='Registered Successfully';
  static String loginSuccessMessage='Logged in Successfully';
  static String successfullMessage='Successfull';
  static String reviewsuccessfullMessage='Thanks\nReview Submitted Successfully';


  static List<Map<String, dynamic>> citiesList =[
    {
      "city": "The Hague",
      "lat": "52.0767",
      "lng": "4.2986",
