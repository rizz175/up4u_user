class nearbyModel {
  ...
  nearbyModel({this.success, this.error, this.body});
...
class Body {
  ...
  Body({this.nearbyPlaces});

  Body.fromJson(Map<String, dynamic> json) {
    if (json['nearbyPlaces'] != null) {
      nearbyPlaces = <NearbyPlaces>[];
      json['nearbyPlaces'].forEach((v) {
        nearbyPlaces!.add(new NearbyPlaces.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.nearbyPlaces != null) {
      data['nearbyPlaces'] = this.nearbyPlaces!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
